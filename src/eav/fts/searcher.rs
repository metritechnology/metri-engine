...
pub async fn fts_search_entity_ids(
    ...
    debug!("[FTS] Buscando '{}' → {} trigrams para tenant {}", term, trigrams.len(), tenant_id);
...
mod tests {
    ...
    #[test]
    fn dl_exact_match() { assert_eq!(damerau_levenshtein("bomba", "bomba"), 0); }

    #[test]
    fn dl_one_deletion() { assert_eq!(damerau_levenshtein("bomba", "boma"), 1); }

    #[test]
    fn dl_transposition() { assert_eq!(damerau_levenshtein("bomba", "obmba"), 1); }
}
