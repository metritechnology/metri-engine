...
use crate::temporal::time_frame::{TimeFrameCtx, TimeFrameType, resolve_time_frame};
...
pub fn resolve_proto_time_frame(
    tf: &crate::grpc::pb::TimeFrameContext,
) -> Option<TimeRange> {
...
pub fn resolve_fbs_time_frame(
    tf: &crate::janus::fbs::TimeFrameContextT,
) -> Option<TimeRange> {
    let ctx = TimeFrameCtx {
...
pub fn no_time_range() -> TimeRange {
    TimeRange { start_ts: None, end_ts: None }
}
