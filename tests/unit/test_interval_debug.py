...
def main():
    ...
    # No timeframe context to scan everything or larger range
                ...
                if batch_res.status.success:
                    ...
                    if batch_res.HasField("data"):
                        ...
                        if strategy == "rows_json":
                            ...
                            # Print first 20 rows and any row with value > 1
                            for i, r in enumerate(rows):
                                ...
                                if i < 20 or (len(row_vals) > 1 and row_vals[1] is not None and row_vals[1] > 1):
