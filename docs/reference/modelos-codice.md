...
| `work_order` | oltp | `work_order_number`, `title`, `description`, `request_id`, `client_id`, `asset_id`, `location_id`, `require_location_verification`, `assignees`, `assigned_group_ids`, `category`, `status`, `priority`, `due_date`, `scheduled_start`, `estimated_duration_hours`, `preventive_maintenance_id`, `scheduled_job_id`, `cron_job`, `completed_by`, `completed_at`, `custom_attributes` |
