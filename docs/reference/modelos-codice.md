...
| `labor_log` | oltp | `work_order_id`, `user_id`, `start_time`, `end_time`, `duration_minutes`, `hourly_rate_cents`, `start_latitude`, `start_longitude`, `end_latitude`, `end_longitude`, `is_geofence_verified` |
| `location` | oltp | `name`, `tag`, `floc_code`, `status`, `criticality`, `risk_probability_score`, `risk_impact_score`, `parent_location_id`, `description`, `omniclass_code`, `omniclass_name`, `is_primary`, `latitude`, `longitude`, `address_street`, `address_city`, `address_state_province`, `address_postal_code`, `address_country_iso2`, `area_value`, `area_unit`, `cost_center`, `primary_contact_user_id`, `custom_attributes` |
...
| `work_order` | oltp | `work_order_number`, `title`, `description`, `request_id`, `client_id`, `asset_id`, `location_id`, `require_location_verification`, `assignees`, `assigned_group_ids`, `category`, `status`, `priority`, `due_date`, `scheduled_start`, `estimated_duration_minutes`, `preventive_maintenance_id`, `scheduled_job_id`, `parent_work_order_id`, `is_parent`, `completed_by`, `completed_at`, `custom_attributes` |
